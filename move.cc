...
/*std::vector<boardt> tower_move(boardt board, int x, int y)
{
    std::vector<boardt> res;

    // Move Down
    for(size_t i = 0;  i + x < 8 && board[x + i][y] == ""; i++)
    {
        boardt rboard;
        rboard = board;
        ...
        res.push_back(rboard);
        // Enemy piece reached
        if (x + i < 7 && board[x + i + 1][y][0] != board[x][y][0] && board[x + i + 1][y][0])
        {
            rboard = board;
            rboard[x + i + 1][y] = board[x][y];
            rboard[x][y] = "";
            res.push_back(rboard);
            break;
        }
    ...
    // Move Up
    for(int i = 0;  x - i >= 0 && board[x - i][y] == ""; i++)
    {
        boardt rboard;
        rboard = board;
        rboard[x - i][y] = board[x][y];
        ...
        res.push_back(rboard);
        // Enemy piece reached
        if (x - i > 0 && board[x - i - 1][y][0] != board[x][y][0] && board[x - i - 1][y][0])
        {
            rboard = board;
            rboard[x - i - 1][y] = board[x][y];
            rboard[x][y] = "";
    ...
    // Move right
    for(size_t i = 0;  i + y < 8 && board[x][y + i] == ""; i++)
    {
        boardt rboard;
        rboard = board;
        ...
        res.push_back(rboard);
        // Enemy piece reached
        if (y + i < 7 && board[x][y + i + 1][0] != board[x][y][0] && board[x][y + i + 1][0])
        {
            rboard = board;
            rboard[x][y + i + 1] = board[x][y];
            rboard[x][y] = "";
            res.push_back(rboard);
            break;
        }
    ...
    // Move left
    for(int i = 0; y - i >= 0 && board[x][y - i] == ""; i++)
    {
        boardt rboard;
        rboard = board;
        ...
        res.push_back(rboard);
        // Enemy piece reached
        if (y - i > 0 && board[x][y - i - 1][0] != board[x][y][0] && board[x][y - i - 1][0])
        {
            rboard = board;
            rboard[x][y - i - 1] = board[x][y];
            rboard[x][y] = "";
